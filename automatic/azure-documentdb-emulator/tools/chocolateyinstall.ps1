...
$packageName= 'documentdb-emulator' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  softwareName  = 'documentdb-emulator*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
